...
exports.saveTruck = catchAsync(async (req, res, next) => {
    try {
        ...
        return res.status(200).json({
            status: true,
            message: 'Truck Successfully Created.',
            data: createdTruck
        });
...
exports.getAllTruck = catchAsync(async (req, res, next) => {
    try {
        let filter = {
...
exports.updateTruck = catchAsync(async (req, res, next) => {
    try {
        ...
        const updatedTruck = await Truck.findByIdAndUpdate(_id, rest, { new: true });
        return res.status(200).json({
            status: true,
